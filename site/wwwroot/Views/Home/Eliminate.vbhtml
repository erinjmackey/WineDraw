    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            ...
            <form method="post" action="">
                <input type="text" class="form-control" name="playerId" value="" placeholder="Ticket Numbers (e.g. 1,3,7)" style="height: 60px;font-size: 20px;"/>
                <input type="password" class="form-control" name="password" value="" placeholder="password" style="height: 60px;font-size: 20px;"/>
                <input type="submit" value="Submit" class="btn btn-default" style="font-size: 23px;"/>
            </form>
        </div>
    </div>
    <div class="row">
