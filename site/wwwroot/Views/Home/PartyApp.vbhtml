...
<head>
    ...
    <style>
		...
		.team-eliminated{
			background-image: url(https://mackeywinedraw.azurewebsites.net/images/eliminatednew.png);
...
<body style="background-color:#600; margin-left:15px; margin-right:15px;">
  <h1 style="color:white;text-align: center;margin-top:55px;margin-bottom:30px;">2024 Mackey Wine Draw</h1>
    ...
    @<div class="col">
      <div class="card" >
        ...
        @If t.IsEliminated Then
          @<div class="card-body team-eliminated">
        ...
        Else
          @<div class="card-body" >
            <ul class="list-group list-group-flush">
             @For Each p As WineDraw.Foundation.Player In t.Players
               If p.isElim Then
                 @<li class="list-group-item player-eliminated">@p.Name</li>
               Else
                 @<li class="list-group-item">@p.Name</li>
               End If
             Next
